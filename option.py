...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='/data/rz/data',
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='SRSpine_DRN',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='SRSpine_DRN',
...
parser.add_argument('--model', type=str, default='DRN-S',
                    help='model name: DRN-S | DRN-L', required=True)
...
parser.add_argument('--save', type=str, default='./experiments/test/',
